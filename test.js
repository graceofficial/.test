...
app.get('/logo', (req, res) => {
    res.sendFile(__dirname+'/public/assets/localStorage.png')
    res.sendFile
});
...
app.put('/mahasiswa/:nim', (req, res) =>{
    ...
    res.send(`Ini routing PUT /mashasiswa/${nim} untuk membuat mengedit data mahasiswa
    dengan NIM : ${nim}`)
});
app.delete('/mahasiswa/:nim', (req, res) => {
    const nim = req.params.nim;
    res.send(`  Ini routing DELETE / mahasiswa/${nim} untuk menghapus data mahasiswa
    dengan  NIM : ${nim}`)
})
